        ...
        <div class="ma-modal">
            <div class="ma-modal__header">
                <div class="ma-modal__head">
                    <h2 class="ma-modal__title ma-page-heading__title ma-page-heading__title--sm"><?php esc_html_e( 'Change Password', 'woocommerce' ); ?></h2>
                    <p class="ma-modal__description"><?php esc_html_e( 'Choose a strong new password and confirm it before saving your changes.', 'myaccount-core' ); ?></p>
                </div>
