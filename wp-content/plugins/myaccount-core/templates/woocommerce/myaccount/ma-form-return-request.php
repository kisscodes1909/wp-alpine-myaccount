	...
	<div class="ma-modal">
		<div class="ma-modal__header">
			<div class="ma-modal__head">
				<h2 class="ma-modal__title ma-page-heading__title ma-page-heading__title--sm ma-view-order-returns__form-title"><?php esc_html_e( 'Create a return request', 'myaccount-core' ); ?></h2>
				<p class="ma-modal__description ma-view-order-returns__form-description"><?php esc_html_e( 'Select the item quantities you want us to review, choose return or exchange, and tell us what happened.', 'myaccount-core' ); ?></p>
			</div>
			<button type="button" class="ma-modal__close ma-btn ma-btn--ghost" @click="$store.popup.closePopup()" aria-label="<?php esc_attr_e( 'Close', 'myaccount-core' ); ?>">
