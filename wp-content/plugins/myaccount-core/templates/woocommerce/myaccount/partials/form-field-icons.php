...
if ( ! function_exists( 'ma_form_icon_lock_closed' ) ) {
	...
	function ma_form_icon_lock_closed() {
		?>
		<svg class="ma-form__input-icon-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
			<!-- Explicit arc flags (1 0 -9 0) so path is never misparsed as 10-9. -->
...
if ( ! function_exists( 'ma_form_icon_phone' ) ) {
	/** Phone icon – phone number fields (Heroicons outline 24). */
...
if ( ! function_exists( 'ma_form_icon_arrow_right' ) ) {
	/** Arrow right – primary CTA (e.g. Sign In button). */
	function ma_form_icon_arrow_right() {
		?>
		<svg class="ma-form__input-icon-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
...
if ( ! function_exists( 'ma_form_icon_google' ) ) {
	/** Google logo – social login button. */
	function ma_form_icon_google() {
		?>
		<svg class="ma-auth__social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" width="16" height="16">
...
if ( ! function_exists( 'ma_form_icon_apple' ) ) {
	/** Apple logo – social login button. */
	function ma_form_icon_apple() {
		?>
		<svg class="ma-auth__social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="16" height="16">
			<path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.42.42 1.75-.96 3.69-3.74 4.42z"/>
		</svg>
		<?php
	}
}
