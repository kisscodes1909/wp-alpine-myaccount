	...
	<div class="ma-order-details-header__inner">
		...
		<div class="ma-order-details-header__right">
			...
			<div class="ma-order-details-header__actions">
				...
				if ( $invoice_url ) :
					?>
					<a href="<?php echo esc_url( $invoice_url ); ?>" class="ma-order-details-header__btn ma-order-details-header__btn--secondary" aria-label="<?php esc_attr_e( 'Download invoice', 'woocommerce' ); ?>">
				...
				<?php endif; ?>
				<a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="ma-order-details-header__btn ma-order-details-header__btn--secondary" aria-label="<?php esc_attr_e( 'Help', 'woocommerce' ); ?>">
					<svg class="ma-order-details-header__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
				...
				<?php if ( $can_cancel ) : ?>
					...
					<form action="" method="post" class="ma-order-details-header__cancel-form">
						...
						<button type="submit" class="ma-order-details-header__btn ma-order-details-header__btn--danger" <?php echo $request_cancellation ? 'disabled' : ''; ?>>
							<svg class="ma-order-details-header__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
