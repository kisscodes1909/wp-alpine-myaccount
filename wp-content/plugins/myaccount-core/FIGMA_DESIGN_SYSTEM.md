...
- **Conventions:** Escape output (`esc_html`, `esc_attr`, `esc_url`), semantic HTML, ARIA where needed; comments in English; follow `.cursor/rules/woocommerce-bricks.mdc` for Woo/Bricks and My Account classes.
