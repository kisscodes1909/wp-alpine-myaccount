...
jQuery( function( $ ) {
    ...
    var disable_wishlist_for_unauthenticated_users = $('#yith_wcwl_disable_wishlist_for_unauthenticated_users'),
        ...
        ask_estimate_text_customization_options = $( '.yith_wcwl_text_section_settings' ),
        text_customization_section              = ask_estimate_text_customization_options.closest( '.yith-plugin-fw__panel__section' );
    ...
    show_estimate_button.on( 'change', function(e) {
        var value = $(this).val();

        if ( 'no' === value ) {
            text_customization_section.hide();
        } else {
            text_customization_section.show();
        }
    });
