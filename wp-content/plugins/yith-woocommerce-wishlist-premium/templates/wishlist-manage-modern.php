								...
								<tr>
									<td class="value" colspan="2">
										...
										<?php if ( $show_delete_wishlist ) : ?>
											<a class="wishlist-delete" onclick="return confirm('<?php echo esc_html( apply_filters( 'yith_wcwl_confirm_wishlist_deletion_message', __( 'Are you sure you want to delete this wishlist?', 'yith-woocommerce-wishlist' ) ) ); ?>');" href="<?php echo esc_url( $wishlist->get_delete_url() ); ?>"><i class="fa fa-trash"></i></a>
										<?php endif; ?>
									</td>
								</tr>
							<?php endif; ?>
