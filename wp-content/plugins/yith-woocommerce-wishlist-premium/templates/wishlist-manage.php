			...
			<tr data-wishlist-id="<?php echo esc_attr( $wishlist->get_id() ); ?>">
				...
				<?php if ( $show_delete_wishlist ) : ?>
					<td class="wishlist-delete">
						<a class="button wishlist-delete" onclick="return confirm('<?php echo esc_html( apply_filters( 'yith_wcwl_confirm_wishlist_deletion_message', __( 'Are you sure you want to delete this wishlist?', 'yith-woocommerce-wishlist' ) ) ); ?>');" href="<?php echo esc_url( $wishlist->get_delete_url() ); ?>"><?php esc_html_e( 'Delete', 'yith-woocommerce-wishlist' ); ?></a>
					</td>
				<?php endif; ?>
			</tr>
