<?php
class WooCommerceCustomRegistration {
    ...
    public function __construct() {
        ...
        add_filter('woocommerce_account_menu_items', [$this, 'remove_downloads_tab'], 100);

        add_filter('woocommerce_registration_errors', [$this, 'validate_tos'], 100, 3);
    }
    ...
    public function add_custom_registration_fields_1(): void
    {
        ?>
            <div class="form-group">
                <div class="first_name woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <?php
                ...
                <div class="last_name woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <?php
