...
function get_return_reasons(): array
{
    $cancel_reasons = [
            ""=>"Select a reason",
        "late_delivery" => "Order will arrive too late",
        "wrong_info" => "Wrong address or payment",
        "found_cheaper" => "Cheaper alternatives available",
        "change_of_mind" => "Change of mind",
        "mistake_order" => "Ordered by mistake",
        "other" => "Other reasons"
    ];
